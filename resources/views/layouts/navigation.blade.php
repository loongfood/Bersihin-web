<nav x-data="{ open: false }" class="bg-[#10241C] border-b border-[#1C3A2C]">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-[#9CB5A8] hover:text-[#F4F4EC] focus:outline-none transition ease-in-out duration-150">
